        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Portal berita</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="/cek-berita" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/level" class="menu-link">
                    <div data-i18n="Blank">Level</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/tipe-berita" class="menu-link">
                    <div data-i18n="Blank">tipe Berita</div>
                  </a>
                </li>
