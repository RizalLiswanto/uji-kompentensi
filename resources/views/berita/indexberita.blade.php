        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card mb-3">
              ...
              <div class="row g-0">
                <div class="col-md-4">
                    <img class="card-img card-img-left" src="{{ asset('storage/news/'.$up->images[0]->image) }}" alt="Card image" />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
            ...
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-md-4">
                    <img class="card-img card-img-left" src="{{ 'style/assets/img/elements/12.jpg' }}" alt="Card image" />
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
